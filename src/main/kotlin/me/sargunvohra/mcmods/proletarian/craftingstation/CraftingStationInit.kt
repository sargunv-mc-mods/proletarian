...
object CraftingStationInit {
    ...
    fun register() {
        ...
        Registry.register(Registry.BLOCK_ENTITY_TYPE, ID, BLOCK_ENTITY_TYPE)
    ...
    fun registerClient() {
        BlockEntityRendererRegistry.INSTANCE.register(BLOCK_ENTITY_TYPE, ::CraftingStationRenderer)
